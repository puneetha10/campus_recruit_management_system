...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="col-lg-6">
            <img src="comp.jpeg" alt="" width="600px" height="450px">

        </div>
        <div class="col-lg-6">
            <img src="cdb5aa539b2364e985382a0277ef8bdc.jpg" alt="" width="600px" height="450px">

        </div>
        
        <div class="col-lg-6">
            <img src="Business-Backgrounds-HD-4.jpg" alt="" width="600px" height="450px">

        </div>

        <div class="col-lg-6">
            <img src="unnamed.jpg" alt="" width="600px" height="450px">
